...
export function BadgeWithDot<T extends BadgeTypes>(props: BadgeWithDotProps<T>) {
...
export function BadgeWithIcon<T extends BadgeTypes>(props: BadgeWithIconProps<T>) {
...
export function BadgeWithFlag<T extends BadgeTypes>(props: BadgeWithFlagProps<T>) {
...
export function BadgeWithImage<T extends BadgeTypes>(props: BadgeWithImageProps<T>) {
...
export function BadgeWithButton<T extends BadgeTypes>(props: BadgeWithButtonProps<T>) {
