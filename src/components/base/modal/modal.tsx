...
export function ModalOverlay(props: AriaModalOverlayProps) {
  return (
    <AriaModalOverlay
      {...props}
      className={state =>
...
export function Dialog(props: AriaDialogProps) {
  return <AriaDialog {...props} className={cx('flex w-full items-center justify-center outline-hidden', props.className)} />
}
